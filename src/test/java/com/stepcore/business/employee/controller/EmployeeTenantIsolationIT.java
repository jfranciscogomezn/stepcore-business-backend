...
class EmployeeTenantIsolationIT extends BaseIntegrationTest {

    @Test
    void tenantCannotReadAnotherTenantsEmployee() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/employees/" + id)
